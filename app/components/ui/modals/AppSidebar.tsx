...
import SidebarGroupWrapper from "../../dashboard/sidebar/Group";
import { navMain } from "@/app/seed/dashboardSiderbarSeedGroup1";
  ...
  return (
    <Sidebar variant="sidebar" collapsible="icon" {...props}>
      ...
      <SidebarContent className="scrollbar-thin scrollbar-track-slate-50 scrollbar-thumb-slate-100" >
        ...
        <SidebarGroupWrapper items={navMain} groupLabel="Account" />
        <SidebarGroup>
          <SidebarMenu>
